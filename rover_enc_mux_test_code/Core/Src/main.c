...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  HAL_TIM_Base_Start_IT(&htim1); //start interrupts
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /* I2C1: PB6 = SCL, PB7 = SDA (alt open-drain) */
  /* I2C2: PB10 = SCL, PB11 = SDA (if using I2C2) */
  ...
  GPIO_InitStruct.Pull = GPIO_PULLUP;            // internal pull-up (still use external 4.7k)
